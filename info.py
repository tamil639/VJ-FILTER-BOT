...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5906206984').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002169414492').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jeyakumar6264:jeyakumar6264@disnepwar.uct57.mongodb.net/?retryWrites=true&w=majority&appName=Disnepwar")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
OWNER_LNK = environ.get('OWNER_LNK', '@Movieuploder1982')
